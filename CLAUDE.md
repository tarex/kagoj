...
কাগজ — সহজে বাংলা লিখুন. Next.js app with Avro-style phonetic Bangla typing, AI suggestions, local spell-checking, and adaptive dictionary learning.
...
- **Spell-check**: local Levenshtein-based (`src/lib/local-spell-checker.ts`), AI fallback via `/api/suggestions`
