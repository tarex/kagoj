...
describe('CaptureFrame', () => {
  it('renders content text', () => {
    ...
    render(
      <CaptureFrame content="hello world" title="Test" fontSize={24} aspectRatio="auto" captureRef={ref} />
    );
  ...
  it('renders title when provided', () => {
    const ref = createRef<HTMLDivElement>();
    render(
      <CaptureFrame content="body" title="My Title" fontSize={24} aspectRatio="auto" captureRef={ref} />
    );
  ...
  it('does not render title when empty', () => {
    ...
    const { container } = render(
      <CaptureFrame content="body" title="" fontSize={24} aspectRatio="auto" captureRef={ref} />
    );
  ...
  it('is positioned off-screen', () => {
    const ref = createRef<HTMLDivElement>();
    const { container } = render(
      <CaptureFrame content="text" title="" fontSize={24} aspectRatio="auto" captureRef={ref} />
    );
  ...
  it('uses pre-wrap whitespace for text formatting', () => {
    const ref = createRef<HTMLDivElement>();
    const { container } = render(
      <CaptureFrame content="line1\nline2" title="" fontSize={24} aspectRatio="auto" captureRef={ref} />
    );
    const frame = container.querySelector('.capture-frame');
