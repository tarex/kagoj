...
export const Toolbar: React.FC<ToolbarProps> = React.memo(({
  ...
  return (
    <div className="editor-toolbar">
      ...
      <span className="toolbar-hide-mobile">
      ...
      <span className="toolbar-show-mobile-only">
      ...
      {/* Share as image -- always visible, accented on mobile */}
      <ToolbarSep />
      <button
        onClick={onShareImage}
        className="toolbar-btn toolbar-btn-share"
        data-tooltip="Share as image"
