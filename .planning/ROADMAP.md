...
- [x] **Phase 2: Ghost Text Intelligence** - Upgrade ghost text to AI-powered phrase/sentence suggestions with clear UX (completed 2026-03-27)
...
| 3. Spell Check Overhaul | 1/2 | In Progress|  |
